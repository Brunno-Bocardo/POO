...
public class ContatosDAO {
    ...
    public Contatos listarPorId(int id) throws SQLException {
        ...
        Contatos cadDto = null;
        if (rs.next()) {                                    //se existe linha da consulta
            cadDto.setNomeContato(rs.getString("nome"));    //obtem o segundo valor, via string            
            cadDto.setIdContato(rs.getInt(0));              //adiciona o objeto a lista
        }
        return cadDto;                                //retorna o contato se encontrado
    }
